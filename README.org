...
- *Multiline values* - Indented continuation blocks for structured or plain text values
...
- [[file:vim/][vim/]] - Vim/Neovim ftplugin for KVL
- [[file:vscode/][vscode/]] - VS Code extension for KVL
- [[file:tree-sitter-kvl/][tree-sitter-kvl/]] - Tree-sitter grammar for KVL
